		...
		<Fragment>
			...
			<section className="contact-section">
				<div className="contact-container relative">
					...
					></div>
					<div className="Container ">
						<Row className="justify-between" gutter={{md:30,xs:15}}>
								...
								<div className=" contact-info flex flex-wrap">
									<div className="info-area ">
										...
										<div className="info-item items-center">
											...
											<div className="info-content">
												<h6 className="title text-white">Email</h6>
      ...
      <section className="contact-counter">
            <div className="Container">
              <Row className="justify-center md:gap-0 lg:gap-0" >
                <Col className="md:px-2 lg:px-3 md:pb-4 lg:pb-0  sm:pb-6 xs:px-0 xs:pb-6 " lg={6} md={12} sm={12} xs={24} >
                  <div className="contact-counter-item">
                    <div className="contact-counter-thumb flex justify-center items-center">
                      <div className="">
                          <FaFacebookF style={{lineHeight:'50px'}}/>
                      </div>
                    </div>
                    <div className="contact-counter-content">
                    <div className="counter-item">
                      <h5 className="title">130</h5>
                ...
                <Col className="md:px-2 lg:px-3 md:pb-4 lg:pb-0  sm:pb-6 xs:px-0 xs:pb-6" lg={6} md={12} sm={12} xs={24}>
                  <div className="contact-counter-item active">
                    <div className="contact-counter-thumb flex justify-center items-center">
                      <div className="">
                          <FaUsers style={{lineHeight:'50px'}}/>
                      </div>
                    </div>
                    <div className="contact-counter-content">
                    <div className="counter-item">
                      <h5 className="title">35</h5>
                      <h5 className="title">K</h5>
                ...
                <Col className="md:px-2 lg:px-3 md:pb-4 lg:pb-0  sm:pb-6 xs:px-0 xs:pb-6" lg={6} md={12} sm={12} xs={24}>
                  <div className="contact-counter-item">
                    <div className="contact-counter-thumb flex justify-center items-center">
                      <div className="">
                          <FaTwitter style={{lineHeight:'50px'}}/>
                      </div>
                    </div>
                    <div className="contact-counter-content">
                    <div className="counter-item">
                      <h5 className="title">47</h5>
                      <h5 className="title">K</h5>
                ...
                <Col className="md:px-2 lg:px-3 md:pb-4 lg:pb-0  sm:pb-6 xs:px-0 xs:pb-6" lg={6} md={12} sm={12} xs={24}>
                  <div className="contact-counter-item">
                    <div className="contact-counter-thumb flex justify-center items-center">
                      <div className="">
                          <FaEnvelope style={{lineHeight:'50px'}}/>
                      </div>
                    </div>
                    <div className="contact-counter-content">
                    <div className="counter-item">
                      <h5 className="title">290</h5>
                      <h5 className="title">K</h5>
