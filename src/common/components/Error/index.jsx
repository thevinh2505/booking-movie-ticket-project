			...
			<div className={styles.container}>
				<div className={styles.leftSection}>
					<div className={styles.innerContent}>
						<h1 className={`${styles.heading} cursor-default`}>
							404
						</h1>
						<p
							className={`${styles.subheading} cursor-default text-white`}
						>
							Oops, looks like the page you were looking for is no
							longer here.
						</p>
						<NavLink to="/home" exact className={styles.backToHomeBtn}>
							Back to home
						</NavLink>
					</div>
				</div>
